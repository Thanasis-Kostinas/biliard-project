...
const CreateCategory = () => {
    ...
    return (_jsx(Container, { maxWidth: "sm", children: _jsxs(Paper, { elevation: 3, sx: { p: 4, mt: 5 }, children: [_jsx(Typography, { variant: "h4", gutterBottom: true, children: "Create New Game" }), _jsxs("form", { onSubmit: handleSubmit, children: [_jsx(Box, { mb: 3, children: _jsx(TextField, { select: true, label: "Category", fullWidth: true, value: category, onChange: (e) => setCategory(e.target.value), required: true, SelectProps: {
                                    native: true,
